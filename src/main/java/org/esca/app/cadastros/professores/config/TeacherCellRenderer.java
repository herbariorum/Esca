...
public class TeacherCellRenderer extends DefaultTableCellRenderer {
    @Override
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelect, boolean hasFocus, int row, int column){
        ...
        table.getColumnModel().getColumn(3).setMaxWidth(800); // CARGO
        table.getColumnModel().getColumn(4).setMaxWidth(150); // TELEFONE
